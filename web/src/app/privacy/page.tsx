...
const sections = [
  ...
  ["Your choices", `You may ask us to access, correct, or delete your personal information, subject to applicable legal requirements. Contact ${CONTACT.email} for privacy requests.`],
];
